...
new MBDPrtWbCmdHeader("MBDPrtWbCmdHdr10", "MBDPrtFstTransformMod","PrtFstDeleteCmd",(void *)NULL); //删除紧固件
new MBDPrtWbCmdHeader("MBDPrtWbCmdHdr11", "MBDPrtFstTransformMod","PrtFstUpdateCmd",(void *)NULL); //更新紧固件